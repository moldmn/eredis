...
parse(#pstate{state = undefined} = State, NewData) ->
    ...
    case NewData of
        ...
        %% Moved
        <<$-, "MOVED", $ , Data/binary>> ->
            return_moved(Data, State, status_continue);
...
return_moved(<< Slot:1/binary, $ , Data/binary>>, State, _StateName)->
    return_moved(Slot, Data, State, _StateName);
return_moved(<< Slot:2/binary, $ , Data/binary>>, State, _StateName)->
    return_moved(Slot, Data, State, _StateName);
return_moved(<< Slot:3/binary, $ , Data/binary>>, State, _StateName)->
    return_moved(Slot, Data, State, _StateName);
return_moved(<< Slot:4/binary, $ , Data/binary>>, State, _StateName)->
    return_moved(Slot, Data, State, _StateName);
return_moved(<< Slot:5/binary, $ , Data/binary>>, State, _StateName)->
    return_moved(Slot, Data, State, _StateName);
return_moved(<< Slot:6/binary, $ , Data/binary>>, State, _StateName)->
    return_moved(Slot, Data, State, _StateName);
return_moved(<< Slot:7/binary, $ , Data/binary>>, State, _StateName)->
    return_moved(Slot, Data, State, _StateName);
return_moved(<< Slot:8/binary, $ , Data/binary>>, State, _StateName)->
    return_moved(Slot, Data, State, _StateName).

return_moved(Slot, Data, _State, _StateName)->
   NL = get_newline_pos(Data),
   <<MovedHost:NL/binary, _/binary >> = Data, 
   {moved, {binary_to_integer(Slot), MovedHost}, init()}.
